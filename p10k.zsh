# Generated by Powerlevel10k configuration wizard on 2020-11-02 at 16:02 CST.
# Based on romkatv/powerlevel10k/config/p10k-classic.zsh, checksum 49789.
# Wizard options: compatible, classic, unicode, darkest, 24h time, flat heads,
# flat tails, 2 lines, disconnected, full frame, sparse, concise, transient_prompt,
...
() {
  ...
  if type tokens &> /dev/null && [[ `tokens | grep -P -o "[0-9]+" | head -n 1` =~ 4[0-9][0-9][0-9][0-9] ]]; then
    typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=160
    typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=160
    typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%B%m'
    typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_TEMPLATE='%B%m'
    typeset -g POWERLEVEL9K_CONTEXT_{DEFAULT,SUDO}_{CONTENT,VISUAL_IDENTIFIER}_EXPANSION='admin@`hostname`'
    typeset -g POWERLEVEL9K_CONTEXT_PREFIX='%Badminsh/'
  else
    typeset -g POWERLEVEL9K_CONTEXT_{REMOTE,REMOTE_SUDO}_FOREGROUND=180
    typeset -g POWERLEVEL9K_CONTEXT_FOREGROUND=180
    typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='%n@%m'
